# TraderClaw PR Workflow (High-Volume Collaboration)

This document defines how TraderClaw handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to TraderClaw/project-native labels.
...
- Confirm any required identity-like wording uses TraderClaw/project-native terminology.
