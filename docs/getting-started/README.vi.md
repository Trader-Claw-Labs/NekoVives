...
| Tình huống | Lệnh |
|----------|---------|
| Có API key, muốn cài nhanh nhất | `traderclaw onboard --api-key sk-... --provider openrouter` |
| Muốn được hướng dẫn từng bước | `traderclaw onboard --interactive` |
| Đã có config, chỉ cần sửa kênh | `traderclaw onboard --channels-only` |
...
- Thiết lập nhanh: `traderclaw onboard --api-key "sk-..." --provider openrouter`
- Thiết lập tương tác: `traderclaw onboard --interactive`
- Kiểm tra môi trường: `traderclaw status` + `traderclaw doctor`
