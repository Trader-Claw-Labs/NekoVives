...
## Problem
TraderClaw logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/traderclaw/audit.key"
...
traderclaw audit --user @alice

# Show all high-risk commands
traderclaw audit --risk high

# Show violations from last 24 hours
traderclaw audit --since 24h --violations-only

# Export to JSON for analysis
traderclaw audit --format json --output audit.json
