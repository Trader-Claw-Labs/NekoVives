...
TraderClaw supports Z.AI's GLM models through OpenAI-compatible endpoints.
This guide covers practical setup options that match current TraderClaw provider behavior.

## Overview

TraderClaw supports these Z.AI aliases and endpoints out of the box:
...
### Test with TraderClaw CLI

```bash
# Test agent directly
echo "Hello" | traderclaw agent
