"""
Discord bot integration for TraderClaw.
"""
...
class DiscordBot:
    """
    Discord bot powered by TraderClaw agent with LangGraph tool calling.
    ...
    def __init__(
        ...
        if not DISCORD_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install traderclaw-tools[discord]"
            )
    ...
    def _setup_events(self):
        @self.client.event
        async def on_ready():
            print(f"TraderClaw Discord Bot ready: {self.client.user}")
