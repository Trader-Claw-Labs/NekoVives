...
SYSTEM_PROMPT = """You are TraderClaw, an AI assistant with tool access. Use tools to accomplish tasks.
...
def create_agent(
    ...
    Example:
        ```python
        from traderclaw_tools import create_agent, shell, file_read
