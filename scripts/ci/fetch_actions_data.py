...
Options:
    ...
    --repo OWNER/NAME   Repository (default: traderclaw-labs/traderclaw)
...
def parse_args():
    ...
    parser.add_argument(
        "--repo",
        default="traderclaw-labs/traderclaw",
        help="Repository in OWNER/NAME format (default: traderclaw-labs/traderclaw)",
    )
