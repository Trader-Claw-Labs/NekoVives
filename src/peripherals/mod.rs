...
/// Handle `traderclaw peripheral` subcommands.
    ...
    match cmd {
        crate::PeripheralCommands::List => {
            ...
            if boards.is_empty() {
                ...
                println!();
                println!("Add one with: traderclaw peripheral add <board> <path>");
                println!("  Example: traderclaw peripheral add nucleo-f401re /dev/ttyACM0");
                println!();
