...
/// Serve static files from `/_app/*` path (legacy alias)
...
pub async fn handle_assets(uri: Uri) -> impl IntoResponse {
    // Strip the leading '/' so "assets/foo.js" can be looked up in the embed
