...
const OTP_ISSUER: &str = "TraderClaw";
...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(traderclaw_dir);
...
pub fn secret_file_path(traderclaw_dir: &Path) -> PathBuf {
    traderclaw_dir.join(OTP_SECRET_FILE)
}
