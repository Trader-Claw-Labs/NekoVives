...
pub fn builtin_series() -> Vec<MarketSeries> {
    vec![
        ...
        // NOTE: the 1-hour Up/Down series resolves live via the ET text-date slug
        // (e.g. `bitcoin-up-or-down-april-23-2026-3pm-et`), NOT this `*-updown-1h`
        // prefix. The prefix here is fine for backtesting (which keys off the data
        // dir, not the prefix); live 1h resolution would need the hourly slug-gen.
        MarketSeries {
            id: "eth_1h".into(),
            label: "ETH UP/DOWN 1-hour".into(),
            slug_prefix: "eth-updown-1h".into(),
            data_source: DataSource::Binance,
            symbol: "ETHUSDT".into(),
            cadence: "1h".into(),
            resolution_logic: ResolutionLogic::PriceUp,
            threshold: None,
            unit: Some("$".into()),
            description: "Will ETH/USD be higher in 1 hour?".into(),
            default_script: Some("polymarket_btc_binary.rhai".into()),
            builtin: true,
        },
        MarketSeries {
            id: "sol_15m".into(),
            label: "SOL UP/DOWN 15-min".into(),
            slug_prefix: "sol-updown-15m".into(),
            data_source: DataSource::Binance,
            symbol: "SOLUSDT".into(),
            cadence: "15m".into(),
            resolution_logic: ResolutionLogic::PriceUp,
            threshold: None,
            unit: Some("$".into()),
            description: "Will SOL/USD be higher 15 minutes from now?".into(),
            default_script: Some("polymarket_btc_binary.rhai".into()),
            builtin: true,
        },
        MarketSeries {
            id: "sol_1h".into(),
            label: "SOL UP/DOWN 1-hour".into(),
            slug_prefix: "sol-updown-1h".into(),
            data_source: DataSource::Binance,
            symbol: "SOLUSDT".into(),
            cadence: "1h".into(),
            resolution_logic: ResolutionLogic::PriceUp,
            threshold: None,
            unit: Some("$".into()),
            description: "Will SOL/USD be higher in 1 hour?".into(),
            default_script: Some("polymarket_btc_binary.rhai".into()),
            builtin: true,
        },
        MarketSeries {
            id: "xrp_15m".into(),
            label: "XRP UP/DOWN 15-min".into(),
            slug_prefix: "xrp-updown-15m".into(),
            data_source: DataSource::Binance,
            symbol: "XRPUSDT".into(),
            cadence: "15m".into(),
            resolution_logic: ResolutionLogic::PriceUp,
            threshold: None,
            unit: Some("$".into()),
            description: "Will XRP/USD be higher 15 minutes from now?".into(),
            default_script: Some("polymarket_btc_binary.rhai".into()),
            builtin: true,
        },
