...
const SNAPSHOT_HEADER: &str = "# 🧠 TraderClaw Memory Snapshot\n\n\
    > Auto-generated by TraderClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 TraderClaw Memory Snapshot

> Auto-generated by TraderClaw.
...
I am TraderClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 TraderClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
