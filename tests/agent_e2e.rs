...
//!
//! Ref: https://github.com/Trader-Claw-Labs/Trader-Claw/issues/618 (item 6)

use anyhow::Result;
use async_trait::async_trait;
use serde_json::json;
use std::sync::{Arc, Mutex};
use traderclaw::agent::agent::Agent;
use traderclaw::agent::dispatcher::{NativeToolDispatcher, XmlToolDispatcher};
use traderclaw::agent::memory_loader::MemoryLoader;
use traderclaw::config::MemoryConfig;
use traderclaw::memory;
use traderclaw::memory::Memory;
use traderclaw::observability::{NoopObserver, Observer};
use traderclaw::providers::traits::ChatMessage;
use traderclaw::providers::{
    ChatRequest, ChatResponse, ConversationMessage, Provider, ProviderRuntimeOptions, ToolCall,
};
use traderclaw::tools::{Tool, ToolResult};
...
async fn e2e_multi_turn_with_memory_enrichment() {
    ...
    assert!(req1_user.content.contains("project: traderclaw"));
...
async fn e2e_live_openai_codex_multi_turn() {
    use traderclaw::providers::openai_codex::OpenAiCodexProvider;
    use traderclaw::providers::traits::Provider;
