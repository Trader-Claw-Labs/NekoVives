...
use traderclaw::providers::compatible::AuthStyle;
use traderclaw::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use traderclaw::providers::compatible::OpenAiCompatibleProvider;
